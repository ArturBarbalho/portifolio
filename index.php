...
<body>
    ...
    <h1 id="name" class="mt-5" >ARTUR VINICIUS</h1>
        <p 
         class="w-100 mx-auto mt-5" 
         style="max-width: 1000px;"
        >Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore quos mollitia deserunt cumque rem veniam ipsa laborum ex nihil? Dignissimos quas perferendis eveniet magnam mollitia, reprehenderit ipsam voluptas quaerat aut?</p>
        <a class="btn btn-primary mt-5" href="public/Currículo.pdf" download="Currículo">Download currículo</a>
    </div>
    </div>

<div id="section_title" class="m-5 pt-5">
<h1 class="text-white">HABILIDADES:</h1>
...
<?php foreach($skills as $skill): ?>
    ...
    <div id="skill">
     ...
     <img id="skill_img" src="<?=$skill["img"] ?>" alt="">
    </div>
<?php endforeach; ?>    
</div>
...
<div class="mb-5" id="contaceiner">
        <a id="contact" target="_blank" href="mailto:arthurvinicius@gmail.com">
        <img style="width: 50px;" src="public/email.png" alt="">
        <p>arthurvinicius907@gmail.com</p>
        </a>
        <a id="contact" target="_blank" href="https://wa.me/5584996430239">
        <img style="width: 50px;" src="public/whatsapp.png" alt="">
        <p >(84)99643-0239</p>
        </a>
        <a  id="contact" target="_blank" href="https://www.linkedin.com/in/artur-barbalho-08abb1219/">
